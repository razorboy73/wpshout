<?php
/*
Plugin Name: Last Months Tutorials v3
Description:  Lists all of last months tutorials on a tutorial post - controlled from post
Version: 1.0
Author: Josh Kerbel
License: GPL2
...
class LMTPlugin{
    ...
    add_action("the_content", array($this,"addLMT"));
    }

    function addLMT($content){
        $showLMT = get_post_meta(get_the_ID(),"show_last_months_tutorials",true);
    ...
    function createHTML(){
        ...
        $textStuff = $textStuff . $this->lmtGeneration("beginner");
        return $textStuff;
    ...
    function lmtGeneration($difficulty="beginner"){
        ...
        if( $query->have_posts() ) :
            ...
            $buffer = $buffer. '<h3>'.$difficulty .' Tutorials From Last Month</h3> <ul>';
